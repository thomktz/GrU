...
class GrU:
    ...
    def __new__(self, object, labels=None, title=None, index=None):
        # Numpy arrays
        if isinstance(object, np.ndarray):
            ...
            if len(shape) == 1:
                ...
                if labels is None:
                    return GrU_1d(object, "0", title, index)
                elif isinstance(labels, Iterable):
                    return GrU_1d(object, labels[0], title, index)
                # If not iterable:
                return GrU_1d(object, str(labels), title, index)
                ...
                return GrU_2d(object, labels, title, index)
                ...
                return GrU_3d(object, labels, title)
        ...
        # Pandas Series
            ...
            return GrU_1d(object.values, labels, title, object.index)
        ...
        # Builtin lists
            ...
            return GrU(np.array(object), labels, title)
